          ...
          <div class="program__list">
            <article class="program__item">
              ...
              <div class="program__content">
                <h3 class="program__item-title">Mikrofalówka w klubiku</h3>
                <p class="program__item-text">
                  Ciepły posiłek w przerwie? Bez problemu.
                </p>
              </div>
            </article>
            ...
            <article class="program__item">
              ...
              <div class="program__content">
                ...
                <p class="program__item-text">
                  Więcej okazji do wspólnej zabawy dla całej szkoły.
                </p>
              </div>
            </article>
            ...
            <article class="program__item">
              ...
              <div class="program__content">
                <h3 class="program__item-title">Silent disco</h3>
                <p class="program__item-text">
                  Impreza bez hałasu na korytarzach — sama dobra energia.
                </p>
              </div>
            </article>
            ...
            <article class="program__item">
              ...
              <div class="program__content">
                <h3 class="program__item-title">Dystrybutor wody pitnej</h3>
                <p class="program__item-text">
                  Darmowa, świeża woda dostępna przez cały dzień.
                </p>
              </div>
            </article>
          </div>
